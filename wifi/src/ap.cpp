...
namespace sdk
{
    ...
    res ap::initialize_non_blocking()
    {
        ...
        RETURN_ON_ERR_MSG(esp_event_handler_instance_register(WIFI_EVENT, ESP_EVENT_ANY_ID, &ap_event_handler, NULL, NULL), "esp_event_handler_instance_register: ");
        ...
        RETURN_ON_ERR_MSG(esp_wifi_set_config(WIFI_IF_AP, &wifi_config), "esp_wifi_set_config: ");
